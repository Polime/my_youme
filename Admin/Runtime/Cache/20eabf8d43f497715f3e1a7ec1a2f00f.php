...
<head>
	...
	<title>你我网 </title>
	<link rel="stylesheet" rev="stylesheet" href="__PUBLIC__/Home/css/style.css" type="text/css" media="screen" />
    <link rel="shortcut icon" href="/favicon.ico" />
	<script src="__PUBLIC__/Home/js/common.js" type="text/javascript"></script>
	<script src="__PUBLIC__/Home/js/c_html_js_add.js" type="text/javascript"></script>
	<script src="__PUBLIC__/Home/js/custom.js" type="text/javascript"></script>
	<link rel="alternate" type="application/rss+xml" href="__PUBLIC__/Home/css/feed.css" title="你我网 " />
</head>
